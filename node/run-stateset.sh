...
echo "_____       _____                 _____
 ...
 /____/ \__/ \___/ \__/ \___//____/ \___/\__/"
...
# Create config if not present, deprectate and moving to Stateset config-generator
...
# Register if no certificates; Stateset needs to use doorman for this to work
