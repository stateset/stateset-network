...
object CreatePurchaseOrderFlow {
    ...
    class Purchaser(val purchaseOrderNumber: String,
        ...
        override fun call(): SignedTransaction {
            ...
            val purchaseOrderState = PurchaseOrder(purchaseOrderNumber, purchaseOrderName, purchaseOrderHash, purchaseOrderStatus, description, purchaseDate, deliveryDate, subtotal, total, me, otherParty, createdAt, lastUpdated)
...
object CompletePurchaseOrderFlow {
    @InitiatingFlow
    @StartableByRPC
    class CompletePurchaseOrderFlow(val purchaseOrderNumber: String) : FlowLogic<SignedTransaction>() {
        ...
        override fun call(): SignedTransaction {
            ...
            // Creating the command.
            val requiredSigners = listOf(purchaseOrder.purchaser.owningKey, purchaseOrder.vendor.owningKey)
    ...
    class Vendor(val counterpartySession: FlowSession) : FlowLogic<SignedTransaction>() {
        @Suspendable
        override fun call(): SignedTransaction {
            val signTransactionFlow = object : SignTransactionFlow(counterpartySession) {
                override fun checkTransaction(stx: SignedTransaction) {
                    ...
                    if (counterparty != counterpartySession.counterparty) {
                        throw FlowException("Only the vendor can Complete the Purchase Order")
                    }
                }
            }
...
object CancelPurchaseOrderFlow {
    @InitiatingFlow
    @StartableByRPC
        ...
        override fun call(): SignedTransaction {
            val signTransactionFlow = object : SignTransactionFlow(counterpartySession) {
                override fun checkTransaction(stx: SignedTransaction) {
                    ...
                    val counterparty = ledgerTx.inputsOfType<PurchaseOrder>().single().vendor
                    if (counterparty != counterpartySession.counterparty) {
                        throw FlowException("Only the vendor can Cancel the Purchase Order")
                    }
                }
            }
...
object LeadTransferFlow {
    @StartableByRPC
    @InitiatingFlow
    @Suspendable
    class LeadTransferFlow(val leadId: String,
                           val newController: Party) : FlowLogic<SignedTransaction>() {
        @Suspendable
        override fun call(): SignedTransaction {
            ...
            val transferCommand = Command(LeadContract.Commands.TransferLead(), signers)
     ...
     * The signing is handled by the [SignTransactionFlow].
     */
    @InitiatedBy(LeadTransferFlow::class)
...
class SendMessageFlow(val to: Party,
    ...
    override fun call(): SignedTransaction {
        ...
        val messageState = Message(UniqueIdentifier(), subject, body, fromUserId, to, me, userId, sent, delivered, fromMe, formatted, messageNumber)
...
object CreateApplicationFlow {
    ...
    class Initiator(val applicationId: String,
        ...
        override fun call(): SignedTransaction {
            ...
            val applicationState = Application(applicationId, applicationName, businessAgeRange, businessEmail, businessPhone, businessRevenueRange, businessType, estimatedPurchaseAmount, estimatedPurchaseFrequency, submitted, submittedAt, industry, applicationStatus, serviceHub.myInfo.legalIdentities.first(), otherParty)
