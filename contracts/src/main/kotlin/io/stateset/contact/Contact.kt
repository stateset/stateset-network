    ...
    override fun generateMappedObject(schema: MappedSchema): PersistentState {
        return when (schema) {
            is ContactSchemaV1 -> ContactSchemaV1.PersistentContact(
                    ...
                    contactSource = this.contactSource.toString(),
...
enum class ContactStatus {
    NEW, IN_REVIEW, APPROVED, ACCEPTED, ENGAGED, REJECTED, OPEN, WORKING, CONTACTED, DO_NOT_CONTACT
}
...
@CordaSerializable
enum class ContactRating {
    LOW, MEDIUM, HIGH, TOP, HOT, COLD
}
